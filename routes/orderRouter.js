...
import { validateOrder, checkClientAndCakeIds, checkDate, checkAnyDateExists } from "../middlewares/orderMiddleware.js";
import { registerOrder, getOrdersByDate, getOrders } from "../controllers/orderController.js";
